...
tegakari は、Webページ上の要素を選択し、そのコンテキスト情報（要素情報、フレームワーク、コンポーネント階層など）をMarkdown形式で生成するChrome拡張機能。生成したMarkdownをクリップボードにコピーし、AIエディタ（Claude Code, Cursorなど）で活用することを目的とする。
